            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li class="scroll-to-section"><a href="#events">Products</a></li>
          ...
          <div class="owl-carousel owl-banner">
            <div class="item item-1">
              <div class="header-text">
                ...
                <h2>
We enable businesses market themselves professionally without breaking the bank</h2>
                <div class="buttons">
            ...
            <div class="item item-2">
              <div class="header-text">
                ...
                <h2>Get Noticed in and out of your business</h2>
                <div class="buttons">
                  <div class="main-button">
                    <a href="#">Request Demo</a>
                  </div>
            ...
            <div class="item item-3">
              <div class="header-text">
                ...
                <h2>We offer personalized printing services to cater to your specific needs</h2>
                <div class="buttons">
                  <div class="main-button">
                    <a href="#">Request Demo</a>
                  </div>
